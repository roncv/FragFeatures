...
class DUckExperiment:
    ...
    def __init__(self, experiment_dir, output_dir="analysis", wqb_filename="wqb.txt"):
    ...
    def compound_dirs(self):
        ...
        compound_dirs = [
            dir
            for dir in os.listdir(self.experiment_dir)
            if os.path.isdir(os.path.join(self.experiment_dir, dir))
        ]
        ...
        compound_dirs = [
            dir
            for dir in compound_dirs
            if os.path.isfile(os.path.join(self.experiment_dir, dir, f"{dir}_apo.pdb"))
        ]
        if not compound_dirs:
            raise FileNotFoundError(
                "No compound directories found in the experiment directory."
            )
