...
class DUckFeature():
	...
	def get_ligand_feature_files(self):
		...
		ligand_feature_files = [
			file for file in os.listdir(self.feature_dir)
			  if file.startswith('ligand_feature_metadata')
			    and file.endswith('.json')
				]
		if not ligand_feature_files:
			raise FileNotFoundError("No ligand feature files found in the feature directory.")
	...
	def get_feature_metadata(self):
		...
		for ligand_feature_family in self.ligand_feature_families:
			feature_pair = frozenset([ligand_feature_family, self.protein_feature_family])
